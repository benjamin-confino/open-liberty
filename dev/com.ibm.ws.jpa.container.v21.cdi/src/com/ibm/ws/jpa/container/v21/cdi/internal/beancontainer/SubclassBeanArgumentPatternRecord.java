...
public class SubclassBeanArgumentPatternRecord {

    public final Optional<String> name;
    public final Class beanType;
    public final Object beanLifecycleStrategy;
    public final Object fallbackProducer;

    @SuppressWarnings("rawtypes")
    public SubclassBeanArgumentPatternRecord(Object[] args) {
        if (args.length == 4) {
            String name = (String) args[0];
            this.name = Optional.of(name);
            Class clazz = (Class) args[1];
            beanType = clazz;
            beanLifecycleStrategy = args[2];
            fallbackProducer = args[3];
        } else {
            name = Optional.empty();
            Class clazz = (Class) args[0];
            beanType = clazz;
            beanLifecycleStrategy = args[1];
    ...
    public Class[] getArgumentParamatersForLifestyleStrategyDotCreateBean() {
        ...
        arguments.add(HibernateClassFinder.getBeanLifecycleStrategyInterface());
    ...
    public Class[] getArgumentsForLifestyleStrategyDotCreateBean() {
        ...
        arguments.add(beanLifecycleStrategy);
