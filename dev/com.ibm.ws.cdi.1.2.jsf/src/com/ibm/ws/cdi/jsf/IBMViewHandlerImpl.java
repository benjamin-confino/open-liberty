...
public class IBMViewHandlerImpl extends ConversationAwareViewHandler implements IBMViewHandler {

    private static final TraceComponent tc = Tr.register(IBMViewHandler.class);

    private final String contextID;

    public IBMViewHandlerImpl(ViewHandler delegate, String contextID) {
        super(delegate);
